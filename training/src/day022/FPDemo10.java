...
public class FPDemo10 {
	...
	public static void main(String[] args) {
		...
		ArrayList<Apple> greenApples = filterApples(apples, "Green", 0, 0);
		System.out.println(greenApples);

		ArrayList<Apple> redApples = filterApples(apples, "Red", 0, 0);
	...
	private static ArrayList<Apple> filterApples(ArrayList<Apple> apples, String color, int minWeight, int maxWeight) {
