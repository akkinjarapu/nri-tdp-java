...
public class FPDemo07 {
	...
	public static void main(String[] args) {
		...
		ArrayList<Apple> bigGreenApples =  filterApplesByColorAndWeight(apples, "Green", 101, 501);
	...
	private static ArrayList<Apple> filterApplesByColorAndWeight(ArrayList<Apple> apples, String color, 
			int minWeight, int maxWeight) {
		ArrayList<Apple> weightedApples = new ArrayList<>();
		for(Apple apple : apples) {
			if(color.equals(apple.getColor()) && 
